...
sydDOM.receipt_elem = (name = 'nworah favour',link) =>{
    return createElement(
        ...
        [
            ...
            createElement('a',{href:link,style:'background:lightgrey;border-radius:3px;padding:3px;text-transform:lowercase;font-size:12px;font-weight:500;color:#2b5e6eb8'},['view reciept'])
        ]
    )
}

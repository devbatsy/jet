...
sydDOM.mainPanelText_names = ({index = -1,param = ''} = {}) =>{
    return createElement(
        'p',
        {
            style:'width:fit-content;transition:all linear .2s;font-weight:200;font-size:14px',
            class:'hoverText'
        },
        [
...
sydDOM.mainPanelText_names_header = ({index = -1,param = ''} = {}) =>{
    return createElement(
        'p',
        {
            style:'width: 100%;text-align:center;transition:all linear .2s;font-size:18px;font-weight:500',
            class:'hoverText'
        },
        [
            extract(index,param)

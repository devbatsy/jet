...
sydDOM.paymentInfo = () =>{
    ...
    return createElement(
        'div',
        {
            style:'height:fit-content;max-height:350px;overflow-y:scroll;min-height:200px;background:#ecebeb;position:relative;padding:10px;padding-top:0;display:flex;flex-direction:column;row-gap:20px;align-items:center;font-family:monospace',
        ...
        [
            ...
            createElement(
                'div',
                {
                    style:'padding:10px;background:lightgrey'
                },
                [

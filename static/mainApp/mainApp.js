    ...
    return createElement(
        ...
        [
            createElement(
                'div',
                {
                    style:'height:100vh;width:100vw;top:0;left:0;background:#fff;position:fixed;z-index:2000;display:flex;justify-content:center;align-items:center;flex-direction:column;row-gap:20px;'
                },[
                    createElement('h2' , {style:'font-weight:700;text-transform:capitalize;color:#171717;'},[
                        createElement('strong' , {style:'color:#702670'},['jet']) , ' brands'
                    ]),
                    sydDOM.animator_loader({size:20 , cls:'init_page_loader'})
                ],{
                    type:'init_page_loader_page'
                }
            ),
...
sydDOM.animator_loader = ({size = 20 , cls = '' , initDisplay = 'flex'} = {}) =>{
    return createElement(
        'div',
        {
            style:`position:static;z-index:999;height:fit-content;width:fit-content;padding:10px;display:${initDisplay};align-items:center;justify-content:center;column-gap:${size/2}px;`,
            class:cls
        },
        [
            createElement('div',{style:`min-height:${size}px;min-width:${size}px;border-radius:50%;background:#9d369d;box-shadow:1.5px 0 0px #cccccc;` , class:'animate_ball1'}),
            createElement('div',{style:`min-height:${size}px;min-width:${size}px;border-radius:50%;background:#9d369d;box-shadow:1.5px 0 0px #cccccc;` , class:'animate_ball2'}),
            createElement('div',{style:`min-height:${size}px;min-width:${size}px;border-radius:50%;background:#9d369d;box-shadow:1.5px 0 0px #cccccc;` , class:'animate_ball3'}),
        ]
    )
}
...
sydDOM.contactMessage = () =>{
    ...
    return createElement(
        'div',
        {
            style:'height:fit-content;width:200px;position:fixed;right:20px;bottom:30px;display:flex;justify-content:center;column-gap:8px;align-items:center;padding:0 10px;z-index:900;align-self:flex-end',
